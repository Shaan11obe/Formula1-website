...
const navitems: NavItem[] = [
  {
    ...
    children: [
      ...
      { label: "Aston Martin", link: "#", iconImage: "/astonMartin-logo.jpg" },
      { label: "Haas", link: "#", iconImage: "/haas-logo.jpg" },
      { label: "Racing Bulls", link: "#", iconImage: "/racingbulls-logo.png" },
      { label: "Williams", link: "#", iconImage: "/williams-logo.jpg" },
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: "Charles Leclerc & Lewis Hamilton",
        link: "#",
        iconImage: "/ferrari-logo.jpg",
      },
      {
        label: "Oscar Piastry & Lando Norris",
        link: "#",
        iconImage: "/mclaren-logo.png",
      },
      {
        label: "George Russell & Andrea Kimi Antonelli",
        link: "#",
        iconImage: "/mercedes-logo.png",
      },
      {
        label: "Fernando Alonso & Lance Stroll",
        link: "#",
        iconImage: "/astonMartin-logo.jpg",
      },
      {
        label: "Esterban Ocon & Oliver Bearman",
        link: "#",
        iconImage: "/haas-logo.jpg",
      },
      {
        label: "Liam Lawson & Isack Hadjar",
        link: "#",
        iconImage: "/racingbulls-logo.png",
      },
      {
        label: "Alex Albon & Carlos Sainz",
        link: "#",
        iconImage: "/williams-logo.jpg",
      },
      {
        label: "Pierre Gasly & Franco Colapinto",
        link: "#",
        iconImage: "/alpine-logo.png",
      },
      {
        label: "Gabriel Bortoleto & Nico Hülkenberg",
        link: "#",
