...
const navitems: NavItem[] = [
  {
    ...
    link: "/teams",
    children: [
      { label: "RedBull", link: "/teams/RedBull", iconImage: "${basePath}/red-bull-logo.png" },
      { label: "Ferrari", link: "#", iconImage: "${basePath}/ferrari-logo.png" },
      { label: "Mclaren", link: "#", iconImage: "${basePath}/mclaren-logo.png" },
      { label: "Mercedes", link: "#", iconImage: "${basePath}/mercedes-logo.png" },
      { label: "Aston Martin", link: "#", iconImage: "${basePath}/astonMartin-logo.png" },
      { label: "Haas", link: "#", iconImage: "${basePath}/haas-logo.png" },
      { label: "Racing Bulls", link: "#", iconImage: "${basePath}/racingbulls-logo.png" },
      { label: "Williams", link: "#", iconImage: "${basePath}/williams-logo.png" },
      { label: "Alpine", link: "#", iconImage: "${basePath}/alpine-logo.png" },
      { label: "Kick Sauber", link: "#", iconImage: "${basePath}/sauber-logo.png" },
    ],
  },
  {
    label: "Drivers",
    ...
    children: [
      {
        ...
        iconImage: "${basePath}/red-bull-logo.png",
      },
      {
        label: "Yuki Tsunoda",
      ...
      },
      {
        ...
        iconImage: "${basePath}/ferrari-logo.png",
      },
      {
      ...
      },
      {
        ...
        iconImage: "${basePath}/mclaren-logo.png",
      },
      {
        label: "Lando Norris",
      ...
      },
      {
        ...
        iconImage: "${basePath}/mercedes-logo.png",
        },
        {
      ...
      },
      {
        ...
        iconImage: "${basePath}/astonMartin-logo.png",
      },
      {
        label: "Lance Stroll",
      ...
      },
      {
        label: "Esterban Ocon",
        link: "#",
        iconImage: "${basePath}/haas-logo.png",
      },
      {
      ...
      },
      {
        label: "Liam Lawson",
        link: "#",
        iconImage: "${basePath}/racingbulls-logo.png",
      },
      {
        label: "Isack Hadjar",
        link: "#",
      ...
      },
      {
        label: "Alex Albon",
        link: "#",
        iconImage: "${basePath}/williams-logo.png",
      },
      {
        label: "Carlos Sainz",
        link: "#",
      ...
      },
      {
        label: "Pierre Gasly",
        link: "#",
        iconImage: "${basePath}/alpine-logo.png",
      },
      {
      ...
      },
      {
        ...
        link: "#",
        iconImage: "${basePath}/sauber-logo.png",
      },
      {
